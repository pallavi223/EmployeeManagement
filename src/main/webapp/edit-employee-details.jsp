	...
	<div class="d-md-flex h-100">
		<div class="container-fluid" style="align-content: center;">
			<fieldset class="scheduler-border">
				...
				<!-- Form Begins -->
				<form class="form" action="save-employee">
					...
					<div class="row form-group">
						...
						<div class="col-75">
							<input type="text" class="form-control" id="empCode"
								name="empCode" pattern=".{,100}"
								value="<c:out value='${empObject.getEmpCode()}' />" readonly>
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-75">
							<input type="text" class="form-control" id="empName"
								name="empName" pattern=".{,100}"
								value="<c:out value='${empObject.getEmpName()}' />" required>
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-75">
							<textarea id="location" class="md-textarea form-control" rows="3"
								name="location" required><c:out
									value='${empObject.getLocation()}' /></textarea>
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-75">
							<input type="email" class="form-control" id="email" name="email"
								pattern=".{,100}"
								value="<c:out value='${empObject.getEmail()}' />" required>
						</div>
					</div>
					...
					<div class="row form-group">
						...
						<div class="col-75">
							<input type="text" class="form-control" id="dateOfBirth"
								name="dateOfBirth"
								value="<c:out value='${empObject.getdOB()}' />" required>
						</div>
					</div>
